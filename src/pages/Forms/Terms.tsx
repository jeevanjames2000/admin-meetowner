...
import { fetchTerms, updateTerms } from "../../store/slices/legals";
...
const TermsPage: React.FC = () => {
  ...
  const { terms, loading, error, updateSuccess } =
  ...
  useEffect(() => {
    if (terms) {
      setFormData((prev) => ({ ...prev, description: terms }));
    }
  }, [terms]);
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    dispatch(updateTerms(formData.description));
  };
